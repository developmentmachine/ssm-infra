package github.developmentmachine.ssm.annotation;
...
import github.developmentmachine.ssm.util.WebUtils;
...
public  class SystemLogAspect {    
    ...
    //Controller层切点    
    @Pointcut("@annotation(github.developmentmachine.ssm.annotation.SysLog)")
